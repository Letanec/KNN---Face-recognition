...
from facenet import Pretrained_Facenet
...
def main(args):
    ...
    #model
    model = Pretrained_Facenet(args.arcface)
    ...
    if args.visualize_embedings:
        ...
        train(model, device, args.arcface, train_loader, test_loader, log_dir, model_dir, args.epochs_num, train_acc_interval, test_acc_interval)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model_path", help="set path to model to be loaded", action="store", type=str, default=None)
